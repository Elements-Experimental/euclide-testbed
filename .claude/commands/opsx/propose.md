...
2. **Determine the base branch (Step A)**
...
3. **Check for existing branches (Step B)**
...
- Branches created (or reused): `feat/<slug>` (based on `<base>`) and `spec/<slug>`
- You are now on `spec/<slug>` — ready to commit the spec artifacts
- List of artifacts created with brief descriptions
- What's ready: "All artifacts created! Ready to commit the spec."
- Prompt: "Run `/opsx:commit` to push the spec and open a PR to `feat/<slug>`."
